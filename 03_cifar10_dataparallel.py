...
def train(log_step_interval=100, save_step_interval=1000, eval_step_interval=200, save_path="ckpt", mode="cpu", epochs=10, batch_size=64, resume=""):
    ...
    ####### 1. model move to cuda && use DataParallel #######
...
if __name__ == '__main__':
    ####### 4. batch_size = batch_size_origin * gpu #######
    batch_size = 4 * 2
    train(log_step_interval=1000, save_step_interval=10000, eval_step_interval=200, mode="DataParallel", epochs=100, batch_size=batch_size)